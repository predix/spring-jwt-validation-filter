...
public class HttpServletRequestUtilTest {
    ...
    public void testGetSubdomainFromOneHeader(String requestHeader, List<String> serviceConfigHeaders, String headerValue, String subdomainValue) {
    ...
    private Object[][] headersDataProvider() {
        return new Object[][] { 
                ...
                {"ACS-Zone-Subdomain", Arrays.asList("Predix-Zone-Id","ACS-Zone-Subdomain"),  "acs-test-subdomain", "acs-test-subdomain"}, 
